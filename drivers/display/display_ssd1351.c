...
#define SSD1351_ROTATION_DEGREES(inst) DT_INST_PROP(inst, rotation)

#define SSD1351_DEFAULT_ORIENTATION(inst)                                        \
  (SSD1351_ROTATION_DEGREES(inst) == 0                                           \
       ? DISPLAY_ORIENTATION_NORMAL                                              \
       : (SSD1351_ROTATION_DEGREES(inst) == 90                                   \
              ? DISPLAY_ORIENTATION_ROTATED_90                                   \
              : (SSD1351_ROTATION_DEGREES(inst) == 180                           \
...
#define SSD1351_INIT(inst)                                                     \
  BUILD_ASSERT((SSD1351_ROTATION_DEGREES(inst) == 0) ||                        \
                   (SSD1351_ROTATION_DEGREES(inst) == 90) ||                   \
                   (SSD1351_ROTATION_DEGREES(inst) == 180) ||                  \
                   (SSD1351_ROTATION_DEGREES(inst) == 270),                    \
                "SSD1351 rotation must be 0, 90, 180, or 270 degrees");       \
  static const struct ssd1351_config ssd1351_config_##inst = {                 \
      ...
      .default_orientation = SSD1351_DEFAULT_ORIENTATION(inst),                \
  };                                                                           \
  static struct ssd1351_data ssd1351_data_##inst = {                           \
      .x_offset = DT_INST_PROP(inst, x_offset),                                \
      .y_offset = DT_INST_PROP(inst, y_offset),                                \
      .orientation = SSD1351_DEFAULT_ORIENTATION(inst),                        \
  };                                                                           \
